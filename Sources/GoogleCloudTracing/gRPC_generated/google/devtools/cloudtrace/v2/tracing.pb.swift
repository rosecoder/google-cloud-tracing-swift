...
extension Google_Devtools_Cloudtrace_V2_BatchWriteSpansRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".BatchWriteSpansRequest"
  ...
  static func ==(lhs: Google_Devtools_Cloudtrace_V2_BatchWriteSpansRequest, rhs: Google_Devtools_Cloudtrace_V2_BatchWriteSpansRequest) -> Bool {
